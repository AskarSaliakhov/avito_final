...
export function SelectYear({data, onSelectChange}: Props) {
    const [selectedOptionYear, setSelectedOptionYears] = useState<{ value: string, label: string } | null>(null);

    useEffect(() => {
        const limit = localStorage.getItem("year");
        if (limit) {
    ...
    const handleOptionChange = (selectedOption: any) => {
        ...
        setSelectedOptionYears(selectedOption);
